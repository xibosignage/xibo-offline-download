#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.3 on Sun Oct 31 11:05:15 2010
...
class XiboOfflineDownloadUI(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.tabDownloadVerticalDivider = wx.StaticLine(self.Tabs_Download, -1, style=wx.LI_VERTICAL)
        self.txtOutput = wx.TextCtrl(self.Tabs_Download, -1, "", style=wx.TE_MULTILINE|wx.TE_READONLY|wx.HSCROLL)
        ...
        self.Logo = wx.StaticBitmap(self, -1, wx.Bitmap("/home/alex/XiboOfflineDownload/logo.jpg", wx.BITMAP_TYPE_ANY), style=wx.SUNKEN_BORDER)
    ...
    def __do_layout(self):
        ...
        sizer_5.Add(self.selectedDisplays, 0, wx.EXPAND, 0)
        ...
        tabDownloadSizer.Add(sizer_5, 1, wx.EXPAND|wx.SHAPED, 0)
        tabDownloadSizer.Add(self.tabDownloadVerticalDivider, 0, wx.EXPAND, 0)
        sizer_6.Add(self.txtOutput, 0, wx.EXPAND, 0)
